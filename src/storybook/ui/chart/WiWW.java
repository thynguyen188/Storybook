...
public class WiWW extends AbstractPersonsChart
	...
	private JTable createTable() {
		...
		List<Date> dates;
		if (mainFrame.showAllParts) dates = sceneDAO.findDistinctDates();
		else  dates = sceneDAO.findDistinctDates(part);
		LocationDAOImpl locationDAO = new LocationDAOImpl(session);
		List<Location> locations = locationDAO.findAll();
		documentModel.commit();
		Object[] arrayOfObject1 = ArrayUtils.addAll(new Object[]{I18N.getMsg("location"), ""}, dates.toArray());
