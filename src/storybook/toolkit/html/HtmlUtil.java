...
public class HtmlUtil {
	...
	public static boolean equalsHtml(String html1, String html2) {
		...
		return (s1.equals(s2) || (s1 != null && s1.equals(s2)));
	}
	...
	public static String getHeadWithCSS() {
		return getHeadWithCSS(SbApp.getInstance().getDefaultFont());
	}

	public static String getHeadWithCSS(Font font) {
		String buf = "<head>\n" + "<style type='text/css'>\n";
		// body
		buf+=getDefaultCSS(font);
		buf += "</style>\n"
			+ "</head>\n";
		return (buf);
	}
	...
	public static String getCSS(String nf,Font font) {
		...
		if (nf!=null && !nf.isEmpty()) {
			...
			b.append(HtmlUtil.getDefaultCSS(font));
		}
		b.append("</style>\n");
		return(b.toString());
	}

	public static String getDefaultCSS(Font font) {
		String buf = "";
		// body
		buf += "body {"
