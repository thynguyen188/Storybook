...
public class HTMLBlockAction extends HTMLTextEditAction {
	...
	public static final String[] ELEMENT_TYPES
			= {
				...
				I18N.getMsg("shef.listordered"),
				I18N.getMsg("shef.listunordered")
			};
	...
	public HTMLBlockAction(int type) throws IllegalArgumentException {
		...
		switch (type) {
			...
			case BLOCKQUOTE:
				...
				break;
			case OL:
				putValue(SMALL_ICON, ShefUtils.getIconX16("listordered"));
				putValue(MNEMONIC_KEY, (int) I18N.getMnemonic("shef.listordered"));
				break;
			case UL:
				putValue(SMALL_ICON, ShefUtils.getIconX16("listunordered"));
				putValue(MNEMONIC_KEY, (int) I18N.getMnemonic("shef.listunordered"));
				break;
			default:
				String s = type + "";
