...
public abstract class AbstractActionExt extends AbstractAction
	 ...
	 * <p>
	 * This is a convenience method for <code>putValue</code> with the <code>Action.SHORT_DESCRIPTION</code> key.
	 *
	...
	/**
	 * Sets the long description of the action. This will also set the value of the short description if that value is
	 * null.
	 * <p>
	 * This is a convenience method for <code>putValue</code> with the <code>Action.LONG_DESCRIPTION</code> key.
	 *
	 ...
	 * <p>
	 * This is a convenience method for <code>putValue</code> with the <code>Action.SMALL_ICON</code> key.
	 *
	 ...
	 * <p>
	 * This is a convenience method for <code>putValue</code> with the <code>LARGE_ICON</code> key.
	 *
	 ...
	 * <p>
	 * This is a convenience method for <code>putValue</code> with the <code>Action.NAME</code> key.
	 *
	 ...
	 * <p>
	 * This is a convenience method for <code>putValue</code> with the <code>Action.MNEMONIC_KEY</code> key.
	 * <p>
	 * This method does not validate the value. Please see {@link javax.swing.AbstractButton#setMnemonic(int)} for
	 * details concerning the value of the mnemonic.
	 *
	 ...
	 * <p>
	 * This is a convenience method for <code>putValue</code> with the <code>Action.ACTION_COMMAND_KEY</code> key.
	 *
	 ...
	 * <p>
	 * This is a convenience method for <code>putValue</code> with the <code>Action.ACCELERATOR_KEY</code> key.
	 *
	...
	/**
	 * Will perform cleanup on the object. Should be called when finished with the Action. This should be used if a new
	 * action is constructed from the properties of an old action. The old action properties should be disposed.
	 */
	public void dispose() {
	...
	// Properties etc....
	/**
	 * Indicates if this action has states. If this method returns true then the this will send ItemEvents to
	 * ItemListeners when the control constructed with this action in invoked.
	 *
	...
	/**
	 * Callback method as <code>ItemListener</code>. Updates internal state based on the given ItemEvent.
	 * <p>
	 *
	 * Here: synchs selected property if isStateAction(), does nothing otherwise.
	 *
	 * @param e the ItemEvent fired by a ItemSelectable on changing the selected state.
	 */
	@Override
