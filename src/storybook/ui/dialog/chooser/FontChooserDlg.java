...
public class FontChooserDlg extends JDialog {
	...
	public FontChooserDlg(AbstractDialog parent, Font font) {
		super(parent, true);
		initAll();
		setTitle(I18N.getMsg("font.chooser"));
		if (font == null) {
			font = Sample.getFont();
		} else Sample.setFont(font);
	...
	private void addButtons() {
		...
		JButton ca = new JButton(I18N.getMsg("cancel"));
		...
		ca.addActionListener((ActionEvent e) -> {
			setVisible(false);
			isCanceled = true;
		});
	}
