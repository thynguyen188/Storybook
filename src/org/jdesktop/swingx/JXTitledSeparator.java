...
/**
 * <p>
 * A simple horizontal separator that contains a title.<br/>
 *
 * <p>
 * JXTitledSeparator allows you to specify the title via the {@link #setTitle} method. The title alignment may be
 * specified by using the {@link #setHorizontalAlignment} method, and accepts all the same arguments as the
 * {@link javax.swing.JLabel#setHorizontalAlignment} method.</p>
 *
 * <p>
 * In addition, you may specify an Icon to use with this separator. The icon will appear "leading" the title (on the
 * left in left-to-right languages, on the right in right-to-left languages). To change the position of the title with
 * respect to the icon, call {@link #setHorizontalTextPosition}.</p>
 *
 * <p>
 * The default font and color of the title comes from the <code>LookAndFeel</code>, mimicking the font and color of the
 * {@link javax.swing.border.TitledBorder}</p>
 *
 * <p>
...
public class JXTitledSeparator extends JXPanel {
	...
	/**
	 * Creates a new instance of <code>JXTitledSeparator</code>. The default title is simply an empty string. Default
	 * justification is <code>LEADING</code>, and the default horizontal text position is <code>TRAILING</code> (title
	 * follows icon)
	 */
	...
	/**
	 * Implementation detail. lays out this component, showing/hiding components as necessary. Actually changes the
	 * containment (removes and adds components). <code>JXTitledSeparator</code> is treated as a single component rather
	 * than a container.
	 */
	 ...
	 * Gets the title.
	 *
	 * @return the title being used for this <code>JXTitledSeparator</code>. This will be the raw title text, and so may
	 * include html tags etc if they were so specified in #setTitle.
	 */
	...
	/**
	 * <p>
	 * Sets the alignment of the title along the X axis. If leading, then the title will lead the separator (in
	 ...
	 *
	 * <p>
	 * LEFT and RIGHT always position the text left or right of the separator, respectively, regardless of the language
	 * orientation.</p>
	 *
	 * @param alignment One of the following constants defined in <code>SwingConstants</code>: <code>LEFT</code>,
	 * <code>CENTER</code>, <code>RIGHT</code>, <code>LEADING</code> (the default) or <code>TRAILING</code>.
	 *
	 * @throws IllegalArgumentException if the alignment does not match one of the accepted inputs.
	 * @see SwingConstants
	 ...
	 * <code>SwingConstants</code>: <code>LEFT</code>, <code>CENTER</code>, <code>RIGHT</code>, <code>LEADING</code> or
	 * <code>TRAILING</code>.
	 *
	 ...
	 *
	 * @param position One of the following constants defined in <code>SwingConstants</code>: <code>LEFT</code>,
	 * <code>CENTER</code>, <code>RIGHT</code>, <code>LEADING</code>, or <code>TRAILING</code> (the default).
	 * @throws IllegalArgumentException if the position does not match one of the accepted inputs.
	 */
	...
	/**
	 * Returns the graphic image (glyph, icon) that the <code>JXTitledSeparator</code> displays.
	 *
	 * @return an Icon
	 * @see #setIcon
	 */
