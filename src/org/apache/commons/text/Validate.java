...
import org.apache.commons.text.util.ArrayUtils;
...
public class Validate {
	 ...
	 * only in the case of an error.</p>
	 *
	 ...
	 * custom validation expression.</p>
	 *
	 * <pre>
	 * Validate.isTrue(i &gt; 0);
	 ...
	 *
	 * <p>
	 * The message of the exception is &quot;The validated expression is false&quot;.</p>
	 *
	 * @param expression the boolean expression to check
	 * @throws IllegalArgumentException if expression is {@code false}
	 * @see #isTrue(boolean, String, long)
	 ...
	 *
	 * <p>
	 * The message of the exception is &quot;The validated object is null&quot;.</p>
	 *
	 ...
	 *
	 * <p>
	 * The message in the exception is &quot;The validated collection is empty&quot;.</p>
	 *
	 * @param <T> the collection type
	 * @param collection the collection to check, validated not null by this method
	 * @return the validated collection (never {@code null} method for chaining)
	 ...
	 *
	 * <p>
	 * The message in the exception is &quot;The validated map is empty&quot;.</p>
	 *
	 * @param <T> the map type
	 * @param map the map to check, validated not null by this method
	 * @return the validated map (never {@code null} method for chaining)
	 ...
	 *
	 * <p>
	 * The message in the exception is &quot;The validated character sequence is empty&quot;.</p>
	 *
	 * @param <T> the character sequence type
	 * @param chars the character sequence to check, validated not null by this method
	 * @return the validated character sequence (never {@code null} method for chaining)
	 ...
	 *
	 * <p>
	 * The message in the exception is &quot;The validated character sequence is blank&quot;.</p>
	 *
	 * @param <T> the character sequence type
	 * @param chars the character sequence to check, validated not null by this method
	 * @return the validated character sequence (never {@code null} method for chaining)
	 ...
	 *
	 * <p>
	 * If the array is {@code null}, then the message in the exception is &quot;The validated object is null&quot;.</p>
	 *
	 * <p>
	 * If the array has a {@code null} element, then the iteration index of the invalid element is appended to the
	 * {@code values} argument.</p>
	 *
	 * @param <T> the array type
	 * @param array the array to check, validated not null by this method
	 * @param message the {@link String#format(String, Object...)} exception message if invalid, not null
	 ...
	 * <p>
	 * Validate that the specified argument array is neither {@code null} nor contains any elements that are
	 * {@code null}; otherwise throwing an exception.</p>
	 *
	 ...
	 * null element at index: &quot; followed by the index.</p>
	 *
	 * @param <T> the array type
	 * @param array the array to check, validated not null by this method
	 * @return the validated array (never {@code null} method for chaining)
	 ...
	 *
	 * <p>
	 * If the iterable is {@code null}, then the message in the exception is &quot;The validated object is
	 * null&quot;.</p>
	 *
	 * <p>
	 ...
	 * contains null element at index: &quot; followed by the index.</p>
	 *
	 * @param <T> the iterable type
	 * @param iterable the iterable to check, validated not null by this method
	 * @return the validated iterable (never {@code null} method for chaining)
	 ...
	 *
	 * <p>
	 * If the array is {@code null}, then the message of the exception is &quot;The validated object is null&quot;.</p>
	 *
	 * @param <T> the array type
	 * @param array the array to check, validated not null by this method
	...
	/**
	 * <p>
	 * Validates that the index is within the bounds of the argument array; otherwise throwing an exception.</p>
	 *
	 ...
	 *
	 * <p>
	 * If the collection is {@code null}, then the message of the exception is &quot;The validated object is
	 * null&quot;.</p>
	 *
	 * @param <T> the collection type
	 * @param collection the collection to check, validated not null by this method
	...
	/**
	 * <p>
	 * Validates that the index is within the bounds of the argument collection; otherwise throwing an exception.</p>
	 *
	 ...
	 * invalid: &quot; followed by the index.</p>
	 *
	 * @param <T> the character sequence type
	 * @param chars the character sequence to check, validated not null by this method
	 * @param index the index to check
	 ...
	 *
	 * <p>
	 * The message of the exception is &quot;The validated state is false&quot;.</p>
	 *
	 * @param expression the boolean expression to check
	 ...
	 *
	 * <p>
	 * The syntax of the pattern is the one used in the {@link Pattern} class.</p>
	 *
	...
	/**
	 * <p>
	 * Validates that the specified argument is not {@code NaN}; otherwise throwing an exception.</p>
	 *
	 * <pre>Validate.notNaN(myDouble);</pre>
	 *
	 * <p>
	 * The message of the exception is &quot;The validated value is not a number&quot;.</p>
	 *
	...
	/**
	 * <p>
	 * Validates that the specified argument is not {@code NaN}; otherwise throwing an exception with the specified
	 * message.</p>
	 *
	...
	/**
	 * <p>
	 * Validates that the specified argument is not infinite or {@code NaN}; otherwise throwing an exception.</p>
	 *
	...
	/**
	 * <p>
	 * Validates that the specified argument is not infinite or {@code NaN}; otherwise throwing an exception with the
	 * specified message.</p>
	 *
	 ...
	 * <p>
	 * Validate that the specified argument object fall between the two inclusive values specified; otherwise, throws an
	 * exception with the specified message.</p>
	 *
	 ...
	 *
	 * <p>
	 * The message of the exception is &quot;Expected type: {type}, actual: {obj_type}&quot;</p>
	 *
	 ...
	 * specified message. This method is useful when validating according to an arbitrary class</p>
	 *
	 ...
	 *
	 * <p>
	 * This method is useful when validating that there will be no casting errors.</p>
	 *
	 * <pre>Validate.isAssignableFrom(SuperClass.class, object.getClass());</pre>
	 *
	 * <p>
	 * The message format of the exception is &quot;Cannot assign {type} to {superType}&quot;</p>
	 *
