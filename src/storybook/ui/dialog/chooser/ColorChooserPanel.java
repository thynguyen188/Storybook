/*
PanelColor: Clever Color Chooser with "no color" and
...
public class ColorChooserPanel extends JPanel implements IRefreshable,
		MouseListener {
	...
	public ColorChooserPanel(String title, Color startColor, Color[] colors,
