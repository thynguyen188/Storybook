...
*/
	...
	private JFreeChart createChart(IntervalCategoryDataset paramIntervalCategoryDataset) {
		JFreeChart localJFreeChart = ChartFactory.createGanttChart(I18N.getMsg("chart.gantt.characters.title"), I18N.getMsg("person"), I18N.getMsg("date"), paramIntervalCategoryDataset, true, true, false);
		...
		localCategoryPlot.addRangeMarker(ChartUtil.getDateIntervalMarker(localDate1, localDate2, I18N.getMsg("chart.common.project.duration")), Layer.BACKGROUND);
	...
	private IntervalCategoryDataset createDataset() {
		...
		model.commit();
		TaskSeries lifeTime = new TaskSeries(I18N.getMsg("chart.gantt.lifetime"));
		TaskSeries childHood = new TaskSeries(I18N.getMsg("chart.gantt.childhood"));
		TaskSeries adolescence = new TaskSeries(I18N.getMsg("chart.gantt.adolescence"));
		TaskSeries adultHood = new TaskSeries(I18N.getMsg("chart.gantt.adulthood"));
		TaskSeries retirement = new TaskSeries(I18N.getMsg("chart.gantt.retirement"));
