...
public class CompoundUndoManager implements UndoableEditListener {
	...
	static class UndoAction extends TextAction {
		...
		public UndoAction() {
			...
			putValue(Action.SMALL_ICON, ShefUtils.getIconX16("undo"));
			putValue(ActionManager.LARGE_ICON, ShefUtils.getIconX24("undo"));
	...
	static class RedoAction extends TextAction {
		...
		public RedoAction() {
			...
			putValue(Action.SMALL_ICON, ShefUtils.getIconX16("redo"));
			putValue(ActionManager.LARGE_ICON, ShefUtils.getIconX24("redo"));
