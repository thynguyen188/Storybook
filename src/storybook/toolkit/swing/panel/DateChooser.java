...
public class DateChooser extends AbstractPanel {
	...
	@Override
	public void initUi() {
		SbApp.trace("DateChooser.initUi()");
		setLayout(new MigLayout("flowx, ins 0"));

		dateChooser = new JDateChooser();
		dateChooser.setDateFormatString(SbApp.getInstance().preferences.getString(SbPref.Key.DATEFORMAT, "MM-dd-yyyy"));
		dateChooser.setMinimumSize(new Dimension(120, 20));

		JLabel lbTime = new JLabel(I18N.getColonMsg("time"));
