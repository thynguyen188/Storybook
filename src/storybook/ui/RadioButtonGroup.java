...
import org.apache.commons.text.util.WordUtils;
import org.apache.commons.text.tuple.ImmutablePair;
...
public class RadioButtonGroup {
	private final HashMap<Integer, ImmutablePair<String, String>> groupMap;
	...
	public void add(int number, String attr, String name) {
		groupMap.put(number, new ImmutablePair<>(attr, name));
	}
