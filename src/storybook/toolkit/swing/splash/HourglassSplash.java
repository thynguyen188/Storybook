...
public class HourglassSplash extends JDialog implements IPaintable {
	...
	private static JLabel lbProgress;
	...
	public void initUi() {
		...
		repaint(0);
		toStop=false;
		//new Thread(new HourglassSplash.TheThread()).start();
	}
	...
	public static class TheThread implements Runnable {
		...
		public void run() {
			try {
				...
				Logger.getLogger(HourglassSplash.class.getName()).log(Level.SEVERE, null, ex);
			}
		}
