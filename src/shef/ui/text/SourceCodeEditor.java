...
public class SourceCodeEditor extends SyntaxTextPane {
	...
	/**
	 * Parse a color from the syntax.properties file. It can have the format RRGGBB in hex or AARRGGBB (with alpha
	 * blending)
	 *
	...
	/**
	 * Parse a font from the syntax.properties file. Takes a comma-separated list of the plain,bold and italic
	 * parameters
	 *
